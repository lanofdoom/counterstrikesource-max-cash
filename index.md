...
### Console Variables
``sm_max_cash_enabled``
If set to 1, players start with max cash. Otherwise, if set to 0, players spawn with the standard amount of cash. Default value is 1.
...
[Download Permalink](https://lanofdoom.github.io/counterstrikesource-max-cash/releases/v1.0.0/max_cash.smx)